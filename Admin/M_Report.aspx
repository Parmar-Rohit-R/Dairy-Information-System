<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_Report.aspx.cs" Inherits="DIS.Admin.M_Report" %>
...
<asp:DropDownList ID="ddlEndDate" runat="server"></asp:DropDownList>
<asp:Button ID="btnFilter" runat="server" Text="Show Report" OnClick="btnFilter_Click" />
