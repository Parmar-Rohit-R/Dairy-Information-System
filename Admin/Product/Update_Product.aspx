<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Product.aspx.cs" Inherits="DIS.Admin.Product.Update_Product" %>
...
&nbsp;
    ...
    <asp:Button Text="Add Product" ID="btnAddProduct" runat="server" CssClass="btn-add" OnClick="btnAddProduct_Click" />
             &nbsp;&nbsp;&nbsp;
             <asp:Button ID="btnAddProduct0" runat="server" CssClass="btn-add" CausesValidation="false" Text="Cancel" OnClick="btnAddProduct0_Click" />
             &nbsp;
</asp:Panel>
