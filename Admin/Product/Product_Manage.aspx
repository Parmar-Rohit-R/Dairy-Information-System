<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product_Manage.aspx.cs" Inherits="DIS.Admin.Product.Product_Manage" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" />
    ...
    <link href="P_M.css" rel="stylesheet" />
</head>
<body>
...
&nbsp;
        ...
        <p class="P1">Manage Product Categories&nbsp;</p>
           <p class="P2"><asp:TextBox ID="TextBox1" AutoPostBack="True" placeHolder="Search Product Name" OnTextChanged="txtSearch_TextChanged" runat="server"></asp:TextBox></p>

       <div class="div1">
           <br />
          
          <!-- Products Table -->
<asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="8" CssClass="custom-grid" DataKeyNames="ProductID"
    OnRowDeleting="gvProducts_RowDeleting" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging">
    <Columns>
