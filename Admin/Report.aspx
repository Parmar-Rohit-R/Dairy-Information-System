<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="DIS.Admin.Report" %>
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Daily Report</p>
   
        <div class="div1">
            <br />
&nbsp;&nbsp;&nbsp; Morning&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtMorning" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Evening&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
             <asp:TextBox ID="txtEvening" runat="server"></asp:TextBox>

             <br />
            
             <br />
&nbsp;&nbsp; Total_Cow&nbsp;&nbsp;&nbsp;&nbsp; 
<asp:TextBox ID="txtTotalCow" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total_Farmer&nbsp;&nbsp;
<asp:TextBox ID="txtTotalFarmer" runat="server"></asp:TextBox>
             <br />
             <br />
&nbsp;&nbsp; Total_Buffalo  <asp:TextBox ID="txtTotalBuffalo" runat="server"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total_Milk&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:TextBox ID="txtTotalMilk" runat="server"></asp:TextBox>
             <br />
             <br />
&nbsp;&nbsp; Total_Fat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:TextBox ID="txtTotalFat" runat="server"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total_SNF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:TextBox ID="txtTotalSNF" runat="server"></asp:TextBox>
