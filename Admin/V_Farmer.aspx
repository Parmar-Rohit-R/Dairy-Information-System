<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="V_Farmer.aspx.cs" Inherits="DIS.Admin.V_Farmer" %>
    ...
    <nav class="sidebar">
        <div class="logo-sidebar">
          ...
          <ul>
            ...
            <li>
            <a href="javascript:void(0)" class="dropdown-btn"><i class="fa-solid fa-address-card"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>Farmer Details </b></a>
            <div class="dropdown-content">
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">View Farmer Details</p>
        ...
        <div class="div1">
             <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="8" CssClass="custom-grid" AutoGenerateColumns="False" DataKeyNames="Farmer_ID" OnPageIndexChanging="GridView1_PageIndexChanging">
    <Columns>
