<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Op_Manage.aspx.cs" Inherits="DIS.Op_Manage" %>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" />
    ...
    <link href="Op_M.css" rel="stylesheet" />
</head>
<body>
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Manage Operator Details</p>
                <p class="P2"><asp:TextBox ID="TextBox1" AutoPostBack="True" placeHolder="Search Operator Name" OnTextChanged="txtSearch_TextChanged" runat="server"></asp:TextBox></p>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Operator_Password" HeaderText="Operator_Password" />
        <asp:TemplateField>
               <HeaderTemplate>
