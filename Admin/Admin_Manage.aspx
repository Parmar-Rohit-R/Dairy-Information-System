<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Manage.aspx.cs" Inherits="DIS.Admin.Admin_Manage" %>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" />
    ...
    <link href="Admin_Manage.css" rel="stylesheet" />
</head>
<body>
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Manage Admin Details</p>
        <p class="P2"><asp:TextBox ID="TextBox1" AutoPostBack="True" placeHolder="Search Admin Name" OnTextChanged="txtSearch_TextChanged" runat="server"></asp:TextBox></p>

   
       <div class="div1">
             <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="8"  CssClass="custom-grid" AutoGenerateColumns="False" DataKeyNames="No" 
