...
namespace DIS.Admin
{
    public partial class Admin_Das_Add : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Database1.mdf;Integrated Security=True"))
            {
                ...
                string checkEmailQuery = "SELECT COUNT(*) FROM Singup WHERE UserId = @Email";
                ...
                str = "insert into Singup(Name,UserId,Password,Role) values(@name,@email,@password,@role)";
