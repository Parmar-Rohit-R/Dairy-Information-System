<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View_Milk_Collection.aspx.cs" Inherits="DIS.Admin.View_Milk_Collection" %>
...
&nbsp;
        ...
        <p class="P1">View Milk Collection</p>
       ...
       <div class="div1">
             <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="8" CssClass="custom-grid" AutoGenerateColumns="False" DataKeyNames="No" OnPageIndexChanging="GridView1_PageIndexChanging" >
    <Columns>
