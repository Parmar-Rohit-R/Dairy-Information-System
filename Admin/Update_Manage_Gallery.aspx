<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Manage_Gallery.aspx.cs" Inherits="DIS.Admin.Update_Manage_Gallery" %>
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Update Gallery Photos</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Gallery Photo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:FileUpload ID="fileUpload" runat="server" />&nbsp;&nbsp;
           ...
           <br /><br />
            ...
            <asp:Button ID="btnUpload" CssClass="btn-signup" runat="server" Text="Update" OnClick="btnUpload_Click" />&nbsp;
            
            <asp:Button ID="btnUpload0" CssClass="btn-signup" runat="server" CausesValidation="false" Text="Cancel" OnClick="btnUpload0_Click" /><br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
