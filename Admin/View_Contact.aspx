<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View_Contact.aspx.cs" Inherits="DIS.Admin.View_Contact" %>
    ...
    <nav class="sidebar">
        <div class="logo-sidebar">
           ...
           <ul>
            ...
            <li> <a href="javascript:void(0)" class="dropdown-btn"><i class="fa-solid fa-address-book"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>Contact Us</b> </a>
            <div class="dropdown-content">
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">View Contact Details</p>
                <p class="P2"><asp:TextBox ID="TextBox1" AutoPostBack="True" placeHolder="Search Name" OnTextChanged="txtSearch_TextChanged" runat="server"></asp:TextBox></p>
