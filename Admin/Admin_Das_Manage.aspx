<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Das_Manage.aspx.cs" Inherits="DIS.Admin.Admin_Das_Manage" %>
    ...
    <nav class="sidebar">
        <div class="logo-sidebar">
         ...
         <ul>
            ...
            <li>
            <a href="javascript:void(0)" class="dropdown-btn"><i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b> User Details</b> </a>
            <div class="dropdown-content">
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Manage User Details </p>
        <p class="P2"><asp:TextBox ID="TextBox1" AutoPostBack="True" placeHolder="Search User Name" OnTextChanged="txtSearch_TextChanged" runat="server"></asp:TextBox></p>
       <div class="div1">
