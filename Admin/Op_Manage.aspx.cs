...
namespace DIS
{
    public partial class Op_Manage : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            {
                string query = "SELECT * FROM Operator WHERE Name LIKE @Name + '%'";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                string query = "UPDATE Operator SET Name = @Name, Operator_ID = @UserId, Operator_Password = @Password WHERE No = @No";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Database1.mdf;Integrated Security=True"))
            {
                string query = "DELETE FROM Operator WHERE No = @No";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.AddWithValue("@No", no);
                conn.Open();
                cmd.ExecuteNonQuery();
