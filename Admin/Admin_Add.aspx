<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Add.aspx.cs" Inherits="DIS.Admin.Admin_Add" %>
    ...
    <nav class="sidebar">
        <div class="logo-sidebar">
           ...
           <ul>
            ...
            <li>
            <a href="javascript:void(0)" class="dropdown-btn"><i class="bi bi-person-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>Admin Details</b> </a>
...
&nbsp;
        ...
        <!-- Center Content-->
        <p class="P1">Add Admin Details</p>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtName" ErrorMessage="Enter AdminName" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style1">
                            ...
                            <asp:TextBox ID="txtPassword" runat="server" CssClass="input-box" TextMode="Password"></asp:TextBox>
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPassword" ErrorMessage="Enter AdminPassword" ForeColor="Red"></asp:RequiredFieldValidator>
                                       &nbsp;
                        ...
                        &nbsp;</td>
                        <td>
                            <label>Re-Enter Admin_Password</label>
